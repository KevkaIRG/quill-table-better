...
declare class TableMenus {
    ...
    getColorList(identifier?: string): ColorList[];
    setColorList(identifier: string, colors: ColorList[]): void;
    getUseDimension(identifier?: string): boolean;
    setUseDimension(identifier: string, useDimension: boolean): void;
    convertToRow(): void;
    ...
    extendTableColor(identifier: string, orgColor: ColorList[], custom?: boolean): void;
